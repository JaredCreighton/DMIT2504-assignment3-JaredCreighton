...
class StockService {
  Future getCompanyInfo(String symbol) async {
    var urlUsingOneString = Uri.parse(
        'https://www.alphavantage.co/query?function=OVERVIEW&symbol=$symbol&apikey=YDKVFQ28L9CBWT56');
  ...
  Future getQuote(String symbol) async {
    ...
    var url = Uri.parse(
        'https://www.alphavantage.co/query?function=GLOBAL_QUOTE&symbol=$symbol&apikey=YDKVFQ28L9CBWT56');
